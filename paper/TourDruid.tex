...
After a picture is chosen by a user our system returns the results in 1492ms, which is fast enough in our opinion to make this application useful to a general tourist.
