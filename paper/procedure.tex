...
extraction, codebook generation, and k-d tree construction.  This process is described in Figures 2 and 3.
...
To quantize the SIFT feature space, a codebook with k words was constructed through the use of the k-means algorithm.
...
For each feature within the image we send the features down our k-d tree, and then sum the number of times a feature maps to a respective leaf node or code word for an image.
